--
-- Dynamic Flux Theme Menu for Elephant/Walker
--
Name = "fluxthemes"
NamePretty = "Flux Themes"
...
function GetEntries()
  local entries = {}
  local user_theme_dir = os.getenv("HOME") .. "/.config/flux/themes"
  local flux_path = os.getenv("FLUX_PATH") or ""
  local default_theme_dir = flux_path .. "/themes"
      ...
      if theme_name and not seen_themes[theme_name] then
        ...
        if preview_path and preview_path ~= "" then
          ...
          table.insert(entries, {
            ...
            PreviewType = "file",
            Actions = {
              activate = "flux-theme-set " .. theme_name,
            },
          })
        end
      end
