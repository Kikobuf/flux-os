...
hl.bind("CTRL + ALT + DELETE", hl.dsp.exec_cmd("flux-hyprland-window-close-all"), { description = "Close all windows" })
...
hl.bind("SUPER + O", hl.dsp.exec_cmd("flux-hyprland-window-pop"), { description = "Pop window out (float & pin)" })
hl.bind("SUPER + L", hl.dsp.exec_cmd("flux-hyprland-workspace-layout-toggle"), { description = "Toggle workspace layout" })
...
hl.bind("SUPER + code:61", hl.dsp.exec_cmd("flux-hyprland-monitor-scaling-cycle"), { description = "Cycle monitor scaling" })
hl.bind("SUPER + ALT + code:61", hl.dsp.exec_cmd("flux-hyprland-monitor-scaling-cycle --reverse"), { description = "Cycle monitor scaling backwards" })
