...
hl.window_rule({ match = { class = "(org.flux.bluetui|org.flux.impala|org.flux.wiremix|org.flux.btop|org.flux.terminal|org.flux.bash|org.codeberg.dnkl.foot|org.gnome.NautilusPreviewer|org.gnome.Evince|com.gabm.satty|Flux|About|TUI.float|imv|mpv)" }, tag = "+floating-window" })
...
hl.window_rule({ match = { class = "org.flux.screensaver" }, fullscreen = true })
hl.window_rule({ match = { class = "org.flux.screensaver" }, float = true })
hl.window_rule({ match = { class = "org.flux.screensaver" }, animation = "slide" })
...
-- Image selector.
hl.layer_rule({ match = { namespace = "flux-image-selector" }, no_anim = true })
