if command -v limine &>/dev/null; then
  sudo tee /etc/mkinitcpio.conf.d/flux_hooks.conf <<EOF >/dev/null
...
EOF
  ...
  sudo cp $FLUX_PATH/default/limine/default.conf /etc/default/limine
  ...
  sudo cp $FLUX_PATH/default/limine/limine.conf /boot/limine.conf
  ...
  sudo cp $FLUX_PATH/default/snapper/root /etc/snapper/configs/root
